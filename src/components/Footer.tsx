...
const Footer = () => {
      ...
      return (
            <div className="grid grid-flow-row-dense grid-cols-1 gap-x-8 gap-y-5 lg:grid-cols-3 md:grid-cols-1 bg-[#ffffffcd] justify-items-center items-center h-min-96" id='footer'>
