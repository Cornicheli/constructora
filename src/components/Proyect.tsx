...
const Proyect = () => {
      return (
            <section className='relative'>
                  <div className="absolute -top-24" id="proyect" />
                  <h1 className='text-4xl text-center font-bold text-[#1b1b1c]'>Proyectos</h1>
                  <div className=" flex flex-wrap flex-row gap-10 items-center justify-center py-10">
                        {
                              proyect.proyect.map((item, index) =>
                                    <div className="flex flex-col items-center justify-center w-[450px] h-80 m-auto border-2 rounded-xl mx-5 my-5" key={index}>
