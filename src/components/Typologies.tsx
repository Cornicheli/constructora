      ...
      return (
            ...
            <>
                  <div className="flex flex-col items-center justify-center w-3/4">
                        ...
                        <p className="mt-5 text-center text-lg font-medium text-[#1b1b1c] ">La empresa actualmente ofrece tipologías estandarizadas de 1, 2 y 3 dormitorios, en una sola planta, en sus líneas Clásica, Moderna y Premium. Además, dispone de un departamento especializado para el desarrollo de proyectos a medida.</p>
                  ...
                  <div className=" flex flex-wrap flex-row gap-20 items-center py-10 justify-center">
                        {
                              typologies.typologies.map((item, index) =>
                                    <div className="flex flex-col items-center justify-center w-[450px] h-max-64 m-auto relative border-2 rounded-xl" key={index}>
