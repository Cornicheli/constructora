            ...
            <main className="bg-[#0E2230] flex items-center justify-center flex-col py-10 relative">
                  ...
                  <div className="flex justify-center items-center flex-col h-min-64">
                        ...
                        <p className="mt-10 text-center text-lg font-medium text-white w-3/4">
                              Somos una Empresa Constructora especializada en proyectos de vivienda.
                              Contamos con mas de 15 años de experiencia en el rubro, sumando mas de
                              120.000 m2 de obras realizadas. Llevamos a cabo diversos tipos de
                              proyectos en variadas condiciones y terrenos, en todo el país.
                              <span className="font-bold">
                                    {" "}
                                    Diseñamos, Proyectamos Y Construimos, la casa de tus sueños!!
                              </span>
                        </p>
                  </div>
