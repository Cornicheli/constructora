...
const designsData = [
    ...
    },
    {
        ...
        image: dis16,
        imageHover: dis16a,
        name: 'Doble Esquinera',
        sub: 'Espacio extendido',
        dim: '9 × 4 m',
    },
    {
        num: '14',
...
const CarrouselMultiPisci = () => {
    ...
    const [counter, setCounter] = useState(
        `01 — 04 de ${String(designsData.length).padStart(2, '0')} modelos`,
    );
    ...
    const updateUI = useCallback(() => {
        ...
        const page = Math.min(
            Math.floor((first - 1) / CARDS_PER_PAGE),
            TOTAL_PAGES - 1,
        );
        setCurrentPage(page);
    }, []);
    ...
    return (
        <section
            style={{
                background:
                    'linear-gradient(180deg, rgba(14,33,56,.9) 0%, #0E2138 100%)',
                color: '#fff',
                padding: '110px 0',
                position: 'relative',
            }}>
            <div
                ...
                <div
                    ...
                    <div>
                        <Eyebrow label="Catálogo" className="mb-3" />
                        <h2
                    ...
                    <p
                        className="m-0 text-[14px] leading-[1.6] text-mute-dark"
                        style={{ maxWidth: 360 }}>
                        Tipologías estandarizadas listas para personalizar según
                        el terreno y las necesidades de cada proyecto.
                    </p>
                </div>
            </div>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <div
                                        className="font-serif italic text-mute-dark"
                                        style={{ fontSize: 13, marginTop: 2 }}>
                                        {d.sub}
                                    </div>
                                </div>
                                <div
                                    className="text-mute-dark"
                                    style={{
                                        fontSize: 11,
                                        letterSpacing: '.12em',
                    ...
                    <div style={{ display: 'flex', gap: 8 }}>
                        <button
                            ...
                            onMouseEnter={e => {
                                ...
                                (
                                    e.currentTarget as HTMLButtonElement
                                ).style.background = 'rgba(201,168,118,.08)';
                            }}
                            onMouseLeave={e => {
                                (
                                    e.currentTarget as HTMLButtonElement
                                ).style.borderColor = '#1c3556';
                                (
                                    e.currentTarget as HTMLButtonElement
